...
public final class userlist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                url: baseUrl + 'user/pageUser',\n");
      ...
      out.write("                    {field: 'userNo', title: '用户编号', width: 150},\n");
      out.write("                    {field: 'userName', title: '用户名称', width: 150},\n");
      out.write("                    {field: 'userPwd', title: '用户密码', width: 150},\n");
      ...
      out.write("                    userNo: $('#searchUserNo').val()\n");
      out.write("                });\n");
      out.write("            },\n");
      out.write("            add: function () {\n");
      out.write("                $('#fm').form('clear');\n");
      out.write("                $('#dlg').dialog('open').dialog('center').dialog('setTitle', '添加用户');\n");
      out.write("            },\n");
      ...
      out.write("                if (row){\n");
      out.write("                    $('#dlg').dialog('open').dialog('center').dialog('setTitle', '修改用户');\n");
      out.write("                    $('#fm').form('load', {\n");
      out.write("                        id:row.id,\n");
      out.write("                        userNo:row.userNo,\n");
      out.write("                        userName:row.userName,\n");
      out.write("                        userPwd:row.userPwd\n");
      out.write("                    });\n");
      out.write("                }\n");
      out.write("            },\n");
      ...
      out.write("                var row =$('#tb1').datagrid('getSelected');\n");
      out.write("                if (row){\n");
      out.write("                    $.messager.confirm('Confirm','确定删除用户吗？',function (r) {\n");
      out.write("                        if (r){\n");
      out.write("                            $.post(baseUrl+'user/delete',{id:row.id},function (result) {\n");
      ...
      out.write("                var userNo = document.getElementById(\"userNo\").value;\n");
      out.write("                var userName = document.getElementById(\"userName\").value;\n");
      out.write("                var userPwd = document.getElementById(\"userPwd\").value;\n");
      out.write("                var url = \"\";\n");
      out.write("                if (id){\n");
      out.write("                    url = baseUrl + \"user/update\";\n");
      out.write("                }else {\n");
      out.write("                    url = baseUrl + \"user/insert\";\n");
      out.write("                }\n");
      ...
      out.write("    </div>\n");
      out.write("    用户编号：<input id=\"searchUserNo\" class=\"easyui-textbox\"/>\n");
      ...
      out.write("        </div>\n");
      out.write("        <div class=\"fitem\" style=\"margin-left: 10px;margin-top: 20px;\">\n");
      out.write("            <label>用户编号：</label>\n");
      out.write("            <input name=\"userNo\" id=\"userNo\" class=\"easyui-textbox\" required=\"true\"/>\n");
      out.write("        </div>\n");
      out.write("        <div class=\"fitem\" style=\"margin-left: 10px;margin-top: 20px;\">\n");
